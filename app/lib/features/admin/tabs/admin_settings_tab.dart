  ...
  static const Map<String, List<_Spec>> _categories = {
    ...
    'Automatic reminders': [
      _Spec('reminder_daily_enabled', 'Daily reward reminder',
          SettingKind.toggle),
      _Spec('reminder_daily_title', 'Daily · title', SettingKind.text),
      _Spec('reminder_daily_body', 'Daily · message', SettingKind.text),
      _Spec('reminder_daily_window_hours', 'Daily · min hours between sends',
          SettingKind.number),
      _Spec('reminder_mining_enabled', 'Mining ready reminder',
          SettingKind.toggle),
      _Spec('reminder_mining_title', 'Mining · title', SettingKind.text),
      _Spec('reminder_mining_body', 'Mining · message', SettingKind.text),
      _Spec('reminder_mining_window_hours', 'Mining · min hours between sends',
          SettingKind.number),
      _Spec('reminder_boost_enabled', 'Boost ready reminder',
          SettingKind.toggle),
      _Spec('reminder_boost_title', 'Boost · title', SettingKind.text),
      _Spec('reminder_boost_body', 'Boost · message', SettingKind.text),
      _Spec('reminder_boost_window_hours',
          'Boost · min hours between sends (0 = use cooldown)',
          SettingKind.number),
      _Spec('reminder_unclaimed_enabled', 'Unclaimed BCP reminder',
          SettingKind.toggle),
      _Spec('reminder_unclaimed_title', 'Unclaimed · title', SettingKind.text),
      _Spec('reminder_unclaimed_body', 'Unclaimed · message', SettingKind.text),
      _Spec('reminder_unclaimed_window_hours',
